...
pubcoder.page.id = pubcoder.page.id || 131;
...
$("#obj2440").bind(PubCoder.Events.Tap, function(event) {
	...
	if (window.obj2440_onTap_activeActionGroupIndex != -1) return;
var obj2440_onTap_runningActionsCount = 0;
var obj2440_onTap_loopCount = 0;
...
$("#obj132").trigger('SCEventShow');
$("#obj133").trigger('SCEventShow');
$("#obj2440").trigger('SCEventShow');
